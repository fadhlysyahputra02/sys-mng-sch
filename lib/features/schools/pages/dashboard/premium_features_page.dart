  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<bool>(
      ...
      builder: (context, isDark, _) {
        ...
        final textSubtitleColor = isDark ? Colors.white70 : const Color(0xFF1E1B4B).withValues(alpha: 0.8);

        final listTileBgUnlocked = isDark ? Colors.white.withValues(alpha: 0.04) : Colors.white;
        final listTileBgLocked = isDark ? Colors.white.withValues(alpha: 0.015) : Colors.black.withValues(alpha: 0.02);

        final iconColorLocked = isDark ? Colors.white24 : const Color(0xFF1E1B4B).withValues(alpha: 0.35);
        final textPrimaryColorLocked = isDark ? Colors.white30 : const Color(0xFF1E1B4B).withValues(alpha: 0.45);
        final textSecondaryColorLocked = isDark ? Colors.white24 : const Color(0xFF1E1B4B).withValues(alpha: 0.4);
        final indicatorColorLocked = isDark ? Colors.white30 : const Color(0xFF1E1B4B).withValues(alpha: 0.4);
              ...
              slivers: [
                ...
                SliverToBoxAdapter(
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.workspace_premium_rounded, color: textPrimaryColor.withValues(alpha: 0.8), size: 20),
                        const SizedBox(width: 8),
                        Text(
                    ...
                    delegate: SliverChildBuilderDelegate(
                      (context, index) {
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            color: item.isUnlocked ? listTileBgUnlocked : listTileBgLocked,
                            borderRadius: BorderRadius.circular(20),
                            border: Border.all(
                              color: item.isUnlocked ? cardBorder : cardBorder.withValues(alpha: 0.5),
                            ),
                            boxShadow: isDark
                                ? []
                                : [
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Icon(
                                    item.icon,
                                    color: item.isUnlocked ? item.badgeColor : iconColorLocked,
                                    size: 24,
                                  ),
                                ),
                                const SizedBox(width: 16),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                          ...
                                          Expanded(
                                            child: Text(
                                              ...
                                              style: TextStyle(
                                                fontWeight: FontWeight.bold,
                                                fontSize: 15,
                                                color: item.isUnlocked ? textPrimaryColor : textPrimaryColorLocked,
                                              ),
                                            ),
                                          ),
                                      ...
                                      Text(
                                        ...
                                        style: TextStyle(
                                          fontSize: 12,
                                          color: item.isUnlocked ? textSubtitleColor : textSecondaryColorLocked,
                                          height: 1.4,
                                        ),
                                      ),
                                      ...
                                      Row(
                                        children: [
                                          Icon(
                                            ...
                                            size: 14,
                                            color: item.isUnlocked ? const Color(0xFF10B981) : indicatorColorLocked,
                                          ),
